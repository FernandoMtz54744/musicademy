          ...
          <form action="" className='form-auth form-register-border-color'>
            ...
            <div className='inputs-container'>
              <div className='input-container'>
                ...
                <input className="input-text input-text-register-color" type="email" name='correo' id='correo'/>
              </div>
              <div className='input-container'>
              ...
              <div className='input-container'>
                ...
                <input className='input-text input-text-register-color' type="password" name="password" id="password" />
              </div>
              <div className='input-container'>
                <input className='input-button input-button-register-color' type="submit" name='registro' value="Registrarse"/>
              </div>
              <div className='input-container'>
